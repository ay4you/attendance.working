class WorkloadsController < ApplicationController
  before_action :set_workload, only: [:show, :edit, :update, :destroy, :vote]
  ...
  def create
    ...
    @workload.image_path = params[:workload][:image_path].original_filename
    p workload_params
  ...
  def workload_params
    uploaded_io = params[:workload][:image_path]
    ...
    if uploaded_io.present?
      ...
      params.require(:workload).permit(:name, :image_path, :subject_id, :comments, :score)
