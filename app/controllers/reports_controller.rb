class ReportsController < ApplicationController
  ...
  #   @data_from_select1 = params[:grade_id]
  #
  #   # we get the data for selectbox 2
  #   @data_for_select2 = Student.where(:grade_id => @data_from_select1).all
  #
  ...
  private
    ...
    def report_params
      params.require(:report).permit(:name, :semester, :class_year, :subject_id, :student_id)
    end
end
