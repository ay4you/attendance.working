...
class GradesControllerTest < ActionController::TestCase
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post :create, grade: { department_id: @grade.department_id, grade_name: @grade.grade_name, teacher_id: @grade.teacher_id }
    end
  ...
  test "should update grade" do
    patch :update, id: @grade, grade: { department_id: @grade.department_id, grade_name: @grade.grade_name, teacher_id: @grade.teacher_id }
    assert_redirected_to grade_path(assigns(:grade))
  end
