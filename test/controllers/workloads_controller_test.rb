...
class WorkloadsControllerTest < ActionController::TestCase
  ...
  test "should create workload" do
    assert_difference('Workload.count') do
      post :create, workload: { comments: @workload.comments, image_path: @workload.image_path, name: @workload.name, score: @workload.score, subject_id: @workload.subject_id }
    end
  ...
  test "should update workload" do
    patch :update, id: @workload, workload: { comments: @workload.comments, image_path: @workload.image_path, name: @workload.name, score: @workload.score, subject_id: @workload.subject_id }
    assert_redirected_to workload_path(assigns(:workload))
  end
